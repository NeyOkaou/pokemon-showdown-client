...
sludgewave:{
anim:function(scene,_ref274){var attacker=_ref274[0],defenders=_ref274.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref286){var attacker=_ref286[0],defenders=_ref286.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref289){var attacker=_ref289[0],defenders=_ref289.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref290){var attacker=_ref290[0],defenders=_ref290.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref300=

['x','y',''];_i40<_ref300.length;_i40++){var axis=_ref300[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref302){var attacker=_ref302[0],defenders=_ref302.slice(1);for(var _i42=0;_i42<
...
wish:{
anim:function(scene,_ref314){var attacker=_ref314[0];
...
residualAnim:function(scene,_ref315){var attacker=_ref315[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
healingwish:{
anim:function(scene,_ref316){var attacker=_ref316[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
residualAnim:function(scene,_ref317){var attacker=_ref317[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y+130,
z:attacker.z,
...
surf:{
anim:function(scene,_ref345){var attacker=_ref345[0],defenders=_ref345.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref347){var attacker=_ref347[0],defenders=_ref347.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref349){var attacker=_ref349[0],defenders=_ref349.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref350){var attacker=_ref350[0],defenders=_ref350.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref351){var attacker=_ref351[0],defenders=_ref351.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref352){var attacker=_ref352[0],defenders=_ref352.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref355){var attacker=_ref355[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref380){var attacker=_ref380[0],defenders=_ref380.slice(1);for(var _i61=0;_i61<
