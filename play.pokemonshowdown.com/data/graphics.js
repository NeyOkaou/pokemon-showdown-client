...
shelltrap:{
anim:function(scene,_ref193){var attacker=_ref193[0],defenders=_ref193.slice(1);for(var _i8=0;_i8<
...
springtidestorm:{
anim:function(scene,_ref226){var attacker=_ref226[0],defenders=_ref226.slice(1);
scene.backgroundEffect('#FF99FF',1000,0.3);for(var _i16=0;_i16<

defenders.length;_i16++){var defender=defenders[_i16];for(var _i18=0,_ref228=
['mistball','heart'];_i18<_ref228.length;_i18++){var effect=_ref228[_i18];
for(var i=0;i<4;i++){
...
defenders.length;_i20++){var defender=defenders[_i20];for(var _i22=0,_ref231=
['blackwisp','lightning'];_i22<_ref231.length;_i22++){var effect=_ref231[_i22];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
boomburst:{
anim:function(scene,_ref242){var attacker=_ref242[0],defenders=_ref242.slice(1);for(var _i26=0;_i26<
...
heatwave:{
anim:function(scene,_ref243){var attacker=_ref243[0],defenders=_ref243.slice(1);for(var _i28=0;_i28<
...
icywind:{
anim:function(scene,_ref272){var attacker=_ref272[0],defenders=_ref272.slice(1);for(var _i30=0;_i30<
...
sludgewave:{
anim:function(scene,_ref284){var attacker=_ref284[0],defenders=_ref284.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref297){var attacker=_ref297[0],defenders=_ref297.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref300){var attacker=_ref300[0],defenders=_ref300.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref301){var attacker=_ref301[0],defenders=_ref301.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref312=

['x','y',''];_i40<_ref312.length;_i40++){var axis=_ref312[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref314){var attacker=_ref314[0],defenders=_ref314.slice(1);for(var _i42=0;_i42<
...
healingwish:{
anim:function(scene,_ref328){var attacker=_ref328[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
residualAnim:function(scene,_ref329){var attacker=_ref329[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y+130,
z:attacker.z,
...
surf:{
anim:function(scene,_ref358){var attacker=_ref358[0],defenders=_ref358.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref360){var attacker=_ref360[0],defenders=_ref360.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref362){var attacker=_ref362[0],defenders=_ref362.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref363){var attacker=_ref363[0],defenders=_ref363.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref364){var attacker=_ref364[0],defenders=_ref364.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref365){var attacker=_ref365[0],defenders=_ref365.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref368){var attacker=_ref368[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref393){var attacker=_ref393[0],defenders=_ref393.slice(1);for(var _i61=0;_i61<
