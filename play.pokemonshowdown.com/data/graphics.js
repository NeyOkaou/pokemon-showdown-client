...
shelltrap:{
anim:function(scene,_ref192){var attacker=_ref192[0],defenders=_ref192.slice(1);for(var _i8=0;_i8<
...
bulldoze:{
anim:function(scene,_ref212){var attacker=_ref212[0],defenders=_ref212.slice(1);
scene.$bg.delay(275);
scene.$bg.animate({
top:-90,
bottom:0
...
springtidestorm:{
anim:function(scene,_ref225){var attacker=_ref225[0],defenders=_ref225.slice(1);
scene.backgroundEffect('#FF99FF',1000,0.3);for(var _i16=0;_i16<

defenders.length;_i16++){var defender=defenders[_i16];for(var _i18=0,_ref227=
['mistball','heart'];_i18<_ref227.length;_i18++){var effect=_ref227[_i18];
for(var i=0;i<4;i++){
...
wildboltstorm:{
anim:function(scene,_ref228){var attacker=_ref228[0],defenders=_ref228.slice(1);
scene.backgroundEffect('#F6D434',1000,0.3);for(var _i20=0;_i20<

defenders.length;_i20++){var defender=defenders[_i20];for(var _i22=0,_ref230=
['blackwisp','lightning'];_i22<_ref230.length;_i22++){var effect=_ref230[_i22];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
sandsearstorm:{
anim:function(scene,_ref231){var attacker=_ref231[0],defenders=_ref231.slice(1);
...
alluringvoice:{
anim:function(scene,_ref240){var attacker=_ref240[0];
scene.showEffect('heart',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref241){var attacker=_ref241[0],defenders=_ref241.slice(1);for(var _i26=0;_i26<
...
heatwave:{
anim:function(scene,_ref242){var attacker=_ref242[0],defenders=_ref242.slice(1);for(var _i28=0;_i28<
...
icywind:{
anim:function(scene,_ref271){var attacker=_ref271[0],defenders=_ref271.slice(1);for(var _i30=0;_i30<
...
sludgewave:{
anim:function(scene,_ref283){var attacker=_ref283[0],defenders=_ref283.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref296){var attacker=_ref296[0],defenders=_ref296.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref299){var attacker=_ref299[0],defenders=_ref299.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref300){var attacker=_ref300[0],defenders=_ref300.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref310=

['x','y',''];_i40<_ref310.length;_i40++){var axis=_ref310[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref312){var attacker=_ref312[0],defenders=_ref312.slice(1);for(var _i42=0;_i42<
...
healingwish:{
anim:function(scene,_ref326){var attacker=_ref326[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
residualAnim:function(scene,_ref327){var attacker=_ref327[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y+130,
z:attacker.z,
...
surf:{
anim:function(scene,_ref355){var attacker=_ref355[0],defenders=_ref355.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref357){var attacker=_ref357[0],defenders=_ref357.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref359){var attacker=_ref359[0],defenders=_ref359.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref360){var attacker=_ref360[0],defenders=_ref360.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref361){var attacker=_ref361[0],defenders=_ref361.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref362){var attacker=_ref362[0],defenders=_ref362.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref365){var attacker=_ref365[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref390){var attacker=_ref390[0],defenders=_ref390.slice(1);for(var _i61=0;_i61<
...
clangoroussoulblaze:{
anim:function(scene,_ref463){var attacker=_ref463[0],defenders=_ref463.slice(1);
attacker.anim({x:attacker.x-10,time:300});
