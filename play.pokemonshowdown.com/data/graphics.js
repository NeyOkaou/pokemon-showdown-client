...
mimic:{
anim:function(scene,_ref19){var attacker=_ref19[0],defender=_ref19[1];
...
lifedew:{
anim:function(scene,_ref24){var attacker=_ref24[0],defenders=_ref24.slice(1);for(var _i2=0;_i2<
...
junglehealing:{
anim:function(scene,_ref25){var attacker=_ref25[0],defenders=_ref25.slice(1);
...
populationbomb:{
anim:function(scene,_ref49){var attacker=_ref49[0],defender=_ref49[1];
...
mist:{
anim:function(scene,_ref50){var attacker=_ref50[0],defender=_ref50[1];
var xf=[1,-1,1,-1];
var yf=[1,-1,-1,1];
var xf2=[1,0,-1,0];
var yf2=[0,1,0,-1];
...
lunarblessing:{
anim:function(scene,_ref73){var attacker=_ref73[0],defenders=_ref73.slice(1);for(var _i6=0;_i6<
...
tailglow:{
anim:function(scene,_ref82){var attacker=_ref82[0];
scene.showEffect('electroball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
takeheart:{
anim:function(scene,_ref83){var attacker=_ref83[0];
scene.backgroundEffect('#000000',700,0.2);
scene.showEffect('rainbow',{
x:attacker.x,
y:attacker.y,
...
prepareAnim:function(scene,_ref96){var attacker=_ref96[0],defender=_ref96[1];
attacker.anim({
opacity:0.2,
y:attacker.y+80,
time:300
...
skullbash:{
anim:BattleOtherAnims.contactattack.anim,
prepareAnim:function(scene,_ref97){var attacker=_ref97[0];
attacker.anim({
opacity:0.8,
time:300
},'linear');
...
skyattack:{
anim:BattleOtherAnims.flight.anim,
prepareAnim:function(scene,_ref98){var attacker=_ref98[0];
attacker.anim({
opacity:0.8,
time:300
},'linear');
...
shelltrap:{
anim:function(scene,_ref191){var attacker=_ref191[0],defenders=_ref191.slice(1);for(var _i8=0;_i8<
...
bulldoze:{
anim:function(scene,_ref211){var attacker=_ref211[0],defenders=_ref211.slice(1);
scene.$bg.delay(275);
scene.$bg.animate({
top:-90,
bottom:0
...
springtidestorm:{
anim:function(scene,_ref224){var attacker=_ref224[0],defenders=_ref224.slice(1);
scene.backgroundEffect('#FF99FF',1000,0.3);for(var _i16=0;_i16<

defenders.length;_i16++){var defender=defenders[_i16];for(var _i18=0,_ref226=
['mistball','heart'];_i18<_ref226.length;_i18++){var effect=_ref226[_i18];
for(var i=0;i<4;i++){
...
wildboltstorm:{
anim:function(scene,_ref227){var attacker=_ref227[0],defenders=_ref227.slice(1);
scene.backgroundEffect('#F6D434',1000,0.3);for(var _i20=0;_i20<

defenders.length;_i20++){var defender=defenders[_i20];for(var _i22=0,_ref229=
['blackwisp','lightning'];_i22<_ref229.length;_i22++){var effect=_ref229[_i22];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
sandsearstorm:{
anim:function(scene,_ref230){var attacker=_ref230[0],defenders=_ref230.slice(1);
...
hypervoice:{
anim:function(scene,_ref238){var attacker=_ref238[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
alluringvoice:{
anim:function(scene,_ref239){var attacker=_ref239[0];
scene.showEffect('heart',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref240){var attacker=_ref240[0],defenders=_ref240.slice(1);for(var _i26=0;_i26<
...
heatwave:{
anim:function(scene,_ref241){var attacker=_ref241[0],defenders=_ref241.slice(1);for(var _i28=0;_i28<
...
icywind:{
anim:function(scene,_ref270){var attacker=_ref270[0],defenders=_ref270.slice(1);for(var _i30=0;_i30<
...
sludgewave:{
anim:function(scene,_ref282){var attacker=_ref282[0],defenders=_ref282.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref294){var attacker=_ref294[0],defenders=_ref294.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref297){var attacker=_ref297[0],defenders=_ref297.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref298){var attacker=_ref298[0],defenders=_ref298.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref308=

['x','y',''];_i40<_ref308.length;_i40++){var axis=_ref308[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref310){var attacker=_ref310[0],defenders=_ref310.slice(1);for(var _i42=0;_i42<
...
wish:{
anim:function(scene,_ref322){var attacker=_ref322[0];
...
residualAnim:function(scene,_ref323){var attacker=_ref323[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
healingwish:{
anim:function(scene,_ref324){var attacker=_ref324[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
residualAnim:function(scene,_ref325){var attacker=_ref325[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y+130,
z:attacker.z,
...
mysticalpower:{
anim:function(scene,_ref332){var attacker=_ref332[0];
scene.showEffect('mistball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
surf:{
anim:function(scene,_ref353){var attacker=_ref353[0],defenders=_ref353.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref355){var attacker=_ref355[0],defenders=_ref355.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref357){var attacker=_ref357[0],defenders=_ref357.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref358){var attacker=_ref358[0],defenders=_ref358.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref359){var attacker=_ref359[0],defenders=_ref359.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref360){var attacker=_ref360[0],defenders=_ref360.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref363){var attacker=_ref363[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref388){var attacker=_ref388[0],defenders=_ref388.slice(1);for(var _i61=0;_i61<
...
clangoroussoulblaze:{
anim:function(scene,_ref461){var attacker=_ref461[0],defenders=_ref461.slice(1);
attacker.anim({x:attacker.x-10,time:300});
