...
mist:{
anim:function(scene,_ref51){var attacker=_ref51[0],defender=_ref51[1];
var xf=[1,-1,1,-1];
var yf=[1,-1,-1,1];
var xf2=[1,0,-1,0];
var yf2=[0,1,0,-1];
...
lunarblessing:{
anim:function(scene,_ref74){var attacker=_ref74[0],defenders=_ref74.slice(1);for(var _i6=0;_i6<
...
takeheart:{
anim:function(scene,_ref84){var attacker=_ref84[0];
scene.backgroundEffect('#000000',700,0.2);
scene.showEffect('rainbow',{
x:attacker.x,
y:attacker.y,
...
beautemps:{
anim:function(scene,_ref88){var attacker=_ref88[0];
attacker.anim({
opacity:0,
time:100
},'linear');
...
prepareAnim:function(scene,_ref96){var attacker=_ref96[0];
attacker.anim({
opacity:0.2,
y:attacker.y-80,
time:300
...
prepareAnim:function(scene,_ref98){var attacker=_ref98[0],defender=_ref98[1];
attacker.anim({
opacity:0.2,
y:attacker.y+80,
time:300
...
skullbash:{
anim:BattleOtherAnims.contactattack.anim,
prepareAnim:function(scene,_ref99){var attacker=_ref99[0];
attacker.anim({
opacity:0.8,
time:300
},'linear');
...
skyattack:{
anim:BattleOtherAnims.flight.anim,
prepareAnim:function(scene,_ref100){var attacker=_ref100[0];
attacker.anim({
opacity:0.8,
time:300
},'linear');
...
shelltrap:{
anim:function(scene,_ref196){var attacker=_ref196[0],defenders=_ref196.slice(1);for(var _i8=0;_i8<
...
earthquake:{
anim:function(scene,_ref215){var attacker=_ref215[0],defenders=_ref215.slice(1);
scene.$bg.animate({
top:-90,
bottom:0
},75).animate({
...
bulldoze:{
anim:function(scene,_ref216){var attacker=_ref216[0],defenders=_ref216.slice(1);
scene.$bg.delay(275);
scene.$bg.animate({
top:-90,
bottom:0
...
springtidestorm:{
anim:function(scene,_ref229){var attacker=_ref229[0],defenders=_ref229.slice(1);
scene.backgroundEffect('#FF99FF',1000,0.3);for(var _i16=0;_i16<

defenders.length;_i16++){var defender=defenders[_i16];for(var _i18=0,_ref231=
['mistball','heart'];_i18<_ref231.length;_i18++){var effect=_ref231[_i18];
for(var i=0;i<4;i++){
...
wildboltstorm:{
anim:function(scene,_ref232){var attacker=_ref232[0],defenders=_ref232.slice(1);
scene.backgroundEffect('#F6D434',1000,0.3);for(var _i20=0;_i20<

defenders.length;_i20++){var defender=defenders[_i20];for(var _i22=0,_ref234=
['blackwisp','lightning'];_i22<_ref234.length;_i22++){var effect=_ref234[_i22];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
sandsearstorm:{
anim:function(scene,_ref235){var attacker=_ref235[0],defenders=_ref235.slice(1);
...
hypervoice:{
anim:function(scene,_ref243){var attacker=_ref243[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
alluringvoice:{
anim:function(scene,_ref244){var attacker=_ref244[0];
scene.showEffect('heart',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref245){var attacker=_ref245[0],defenders=_ref245.slice(1);for(var _i26=0;_i26<
...
heatwave:{
anim:function(scene,_ref246){var attacker=_ref246[0],defenders=_ref246.slice(1);for(var _i28=0;_i28<
...
icywind:{
anim:function(scene,_ref275){var attacker=_ref275[0],defenders=_ref275.slice(1);for(var _i30=0;_i30<
...
sludgewave:{
anim:function(scene,_ref287){var attacker=_ref287[0],defenders=_ref287.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref300){var attacker=_ref300[0],defenders=_ref300.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref303){var attacker=_ref303[0],defenders=_ref303.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref304){var attacker=_ref304[0],defenders=_ref304.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref315=

['x','y',''];_i40<_ref315.length;_i40++){var axis=_ref315[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref317){var attacker=_ref317[0],defenders=_ref317.slice(1);for(var _i42=0;_i42<
...
wish:{
anim:function(scene,_ref329){var attacker=_ref329[0];
...
residualAnim:function(scene,_ref330){var attacker=_ref330[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
healingwish:{
anim:function(scene,_ref331){var attacker=_ref331[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
residualAnim:function(scene,_ref332){var attacker=_ref332[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y+130,
z:attacker.z,
...
surf:{
anim:function(scene,_ref361){var attacker=_ref361[0],defenders=_ref361.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref363){var attacker=_ref363[0],defenders=_ref363.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref365){var attacker=_ref365[0],defenders=_ref365.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref366){var attacker=_ref366[0],defenders=_ref366.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref367){var attacker=_ref367[0],defenders=_ref367.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref368){var attacker=_ref368[0],defenders=_ref368.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref371){var attacker=_ref371[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
prepareAnim:function(scene,_ref373){var attacker=_ref373[0];
scene.showEffect('icicle',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref398){var attacker=_ref398[0],defenders=_ref398.slice(1);for(var _i61=0;_i61<
