...
lunarblessing:{
anim:function(scene,_ref72){var attacker=_ref72[0],defenders=_ref72.slice(1);for(var _i6=0;_i6<
...
prepareAnim:function(scene,_ref95){var attacker=_ref95[0],defender=_ref95[1];
attacker.anim({
opacity:0.2,
y:attacker.y+80,
time:300
...
shelltrap:{
anim:function(scene,_ref189){var attacker=_ref189[0],defenders=_ref189.slice(1);for(var _i8=0;_i8<
...
springtidestorm:{
anim:function(scene,_ref221){var attacker=_ref221[0],defenders=_ref221.slice(1);
scene.backgroundEffect('#FF99FF',1000,0.3);for(var _i16=0;_i16<

defenders.length;_i16++){var defender=defenders[_i16];for(var _i18=0,_ref223=
['mistball','heart'];_i18<_ref223.length;_i18++){var effect=_ref223[_i18];
for(var i=0;i<4;i++){
...
defenders.length;_i20++){var defender=defenders[_i20];for(var _i22=0,_ref226=
['blackwisp','lightning'];_i22<_ref226.length;_i22++){var effect=_ref226[_i22];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
hypervoice:{
anim:function(scene,_ref235){var attacker=_ref235[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
alluringvoice:{
anim:function(scene,_ref236){var attacker=_ref236[0];
scene.showEffect('heart',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref237){var attacker=_ref237[0],defenders=_ref237.slice(1);for(var _i26=0;_i26<
...
heatwave:{
anim:function(scene,_ref238){var attacker=_ref238[0],defenders=_ref238.slice(1);for(var _i28=0;_i28<
...
icywind:{
anim:function(scene,_ref266){var attacker=_ref266[0],defenders=_ref266.slice(1);for(var _i30=0;_i30<
...
sludgewave:{
anim:function(scene,_ref278){var attacker=_ref278[0],defenders=_ref278.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref290){var attacker=_ref290[0],defenders=_ref290.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref293){var attacker=_ref293[0],defenders=_ref293.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref294){var attacker=_ref294[0],defenders=_ref294.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref304=

['x','y',''];_i40<_ref304.length;_i40++){var axis=_ref304[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref306){var attacker=_ref306[0],defenders=_ref306.slice(1);for(var _i42=0;_i42<
...
wish:{
anim:function(scene,_ref318){var attacker=_ref318[0];
...
residualAnim:function(scene,_ref319){var attacker=_ref319[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
healingwish:{
anim:function(scene,_ref320){var attacker=_ref320[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
residualAnim:function(scene,_ref321){var attacker=_ref321[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y+130,
z:attacker.z,
...
surf:{
anim:function(scene,_ref349){var attacker=_ref349[0],defenders=_ref349.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref351){var attacker=_ref351[0],defenders=_ref351.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref353){var attacker=_ref353[0],defenders=_ref353.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref354){var attacker=_ref354[0],defenders=_ref354.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref355){var attacker=_ref355[0],defenders=_ref355.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref356){var attacker=_ref356[0],defenders=_ref356.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref359){var attacker=_ref359[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref384){var attacker=_ref384[0],defenders=_ref384.slice(1);for(var _i61=0;_i61<
