...
springtidestorm:{
anim:function(scene,_ref223){var attacker=_ref223[0],defenders=_ref223.slice(1);
scene.backgroundEffect('#FF99FF',1000,0.3);for(var _i16=0;_i16<

defenders.length;_i16++){var defender=defenders[_i16];for(var _i18=0,_ref225=
['mistball','heart'];_i18<_ref225.length;_i18++){var effect=_ref225[_i18];
for(var i=0;i<4;i++){
...
defenders.length;_i20++){var defender=defenders[_i20];for(var _i22=0,_ref228=
['blackwisp','lightning'];_i22<_ref228.length;_i22++){var effect=_ref228[_i22];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
hypervoice:{
anim:function(scene,_ref237){var attacker=_ref237[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref239){var attacker=_ref239[0],defenders=_ref239.slice(1);for(var _i26=0;_i26<
...
heatwave:{
anim:function(scene,_ref240){var attacker=_ref240[0],defenders=_ref240.slice(1);for(var _i28=0;_i28<
...
icywind:{
anim:function(scene,_ref269){var attacker=_ref269[0],defenders=_ref269.slice(1);for(var _i30=0;_i30<
...
sludgewave:{
anim:function(scene,_ref281){var attacker=_ref281[0],defenders=_ref281.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref293){var attacker=_ref293[0],defenders=_ref293.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref296){var attacker=_ref296[0],defenders=_ref296.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref297){var attacker=_ref297[0],defenders=_ref297.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref307=

['x','y',''];_i40<_ref307.length;_i40++){var axis=_ref307[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref309){var attacker=_ref309[0],defenders=_ref309.slice(1);for(var _i42=0;_i42<
...
wish:{
anim:function(scene,_ref321){var attacker=_ref321[0];
...
residualAnim:function(scene,_ref322){var attacker=_ref322[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
healingwish:{
anim:function(scene,_ref323){var attacker=_ref323[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
residualAnim:function(scene,_ref324){var attacker=_ref324[0];
scene.showEffect('wisp',{
x:attacker.x,
y:attacker.y+130,
z:attacker.z,
...
surf:{
anim:function(scene,_ref352){var attacker=_ref352[0],defenders=_ref352.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref354){var attacker=_ref354[0],defenders=_ref354.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref356){var attacker=_ref356[0],defenders=_ref356.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref357){var attacker=_ref357[0],defenders=_ref357.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref358){var attacker=_ref358[0],defenders=_ref358.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref359){var attacker=_ref359[0],defenders=_ref359.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref362){var attacker=_ref362[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref387){var attacker=_ref387[0],defenders=_ref387.slice(1);for(var _i61=0;_i61<
...
astralbarrage:{
anim:function(scene,_ref438){var attacker=_ref438[0],defenders=_ref438.slice(1);
scene.backgroundEffect('#000000',600,0.6);
scene.backgroundEffect('linear-gradient(#000000 10%, #2630A9)',1100,0.6,600);
...
clangoroussoulblaze:{
anim:function(scene,_ref460){var attacker=_ref460[0],defenders=_ref460.slice(1);
attacker.anim({x:attacker.x-10,time:300});
...
terastarstorm:{
anim:function(scene,_ref468){var attacker=_ref468[0],defenders=_ref468.slice(1);
scene.backgroundEffect('#000000',900,0.5);
