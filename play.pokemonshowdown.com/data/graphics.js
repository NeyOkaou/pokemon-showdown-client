...
beautemps:{
anim:function(scene,_ref87){var attacker=_ref87[0];
attacker.anim({
opacity:0,
time:100
},'linear');
...
prepareAnim:function(scene,_ref97){var attacker=_ref97[0],defender=_ref97[1];
attacker.anim({
opacity:0.2,
y:attacker.y+80,
time:300
...
shelltrap:{
anim:function(scene,_ref194){var attacker=_ref194[0],defenders=_ref194.slice(1);for(var _i8=0;_i8<
...
earthquake:{
anim:function(scene,_ref213){var attacker=_ref213[0],defenders=_ref213.slice(1);
scene.$bg.animate({
top:-90,
bottom:0
},75).animate({
...
defenders.length;_i16++){var defender=defenders[_i16];for(var _i18=0,_ref229=
['mistball','heart'];_i18<_ref229.length;_i18++){var effect=_ref229[_i18];
for(var i=0;i<4;i++){
...
defenders.length;_i20++){var defender=defenders[_i20];for(var _i22=0,_ref232=
['blackwisp','lightning'];_i22<_ref232.length;_i22++){var effect=_ref232[_i22];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
sandsearstorm:{
anim:function(scene,_ref233){var attacker=_ref233[0],defenders=_ref233.slice(1);
...
hypervoice:{
anim:function(scene,_ref241){var attacker=_ref241[0];
scene.showEffect('iceball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
alluringvoice:{
anim:function(scene,_ref242){var attacker=_ref242[0];
scene.showEffect('heart',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
boomburst:{
anim:function(scene,_ref243){var attacker=_ref243[0],defenders=_ref243.slice(1);for(var _i26=0;_i26<
...
heatwave:{
anim:function(scene,_ref244){var attacker=_ref244[0],defenders=_ref244.slice(1);for(var _i28=0;_i28<
...
icywind:{
anim:function(scene,_ref273){var attacker=_ref273[0],defenders=_ref273.slice(1);for(var _i30=0;_i30<
...
sludgewave:{
anim:function(scene,_ref285){var attacker=_ref285[0],defenders=_ref285.slice(1);for(var _i32=0;_i32<
...
rockslide:{
anim:function(scene,_ref298){var attacker=_ref298[0],defenders=_ref298.slice(1);for(var _i34=0;_i34<
...
thousandarrows:{
anim:function(scene,_ref301){var attacker=_ref301[0],defenders=_ref301.slice(1);for(var _i36=0;_i36<
...
thousandwaves:{
anim:function(scene,_ref302){var attacker=_ref302[0],defenders=_ref302.slice(1);for(var _i38=0;_i38<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i40=0,_ref313=

['x','y',''];_i40<_ref313.length;_i40++){var axis=_ref313[_i40];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref315){var attacker=_ref315[0],defenders=_ref315.slice(1);for(var _i42=0;_i42<
...
wish:{
anim:function(scene,_ref327){var attacker=_ref327[0];
...
residualAnim:function(scene,_ref328){var attacker=_ref328[0];
scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",600,0.4);
...
surf:{
anim:function(scene,_ref359){var attacker=_ref359[0],defenders=_ref359.slice(1);for(var _i47=0;_i47<
...
muddywater:{
anim:function(scene,_ref361){var attacker=_ref361[0],defenders=_ref361.slice(1);for(var _i49=0;_i49<
...
lavaplume:{
anim:function(scene,_ref363){var attacker=_ref363[0],defenders=_ref363.slice(1);for(var _i51=0;_i51<
...
dragonenergy:{
anim:function(scene,_ref364){var attacker=_ref364[0],defenders=_ref364.slice(1);for(var _i53=0;_i53<
...
eruption:{
anim:function(scene,_ref365){var attacker=_ref365[0],defenders=_ref365.slice(1);for(var _i55=0;_i55<
...
waterspout:{
anim:function(scene,_ref366){var attacker=_ref366[0],defenders=_ref366.slice(1);for(var _i57=0;_i57<
...
prepareAnim:function(scene,_ref369){var attacker=_ref369[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
darkvoid:{
anim:function(scene,_ref394){var attacker=_ref394[0],defenders=_ref394.slice(1);for(var _i61=0;_i61<
